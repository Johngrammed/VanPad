...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// menuStrip1
			// 
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(8) {this->Ù‡ÈÎToolStripMenuItem, 
			...
			// ‚Ë‰ToolStripMenuItem
			// 
			this->‚Ë‰ToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->ÒÚÓÍ‡—ÓÒÚÓˇÌËˇToolStripMenuItem});
			...
			// 
			this->ÍÓ‰ËÓ‚Í‡¬UTF8ToolStripMenuItem->Checked = true;
			this->ÍÓ‰ËÓ‚Í‡¬UTF8ToolStripMenuItem->CheckState = System::Windows::Forms::CheckState::Indeterminate;
